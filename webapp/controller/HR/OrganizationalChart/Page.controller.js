sap.ui.define(['sap/ui/core/mvc/Controller', 'sap/ui/model/json/JSONModel'],
	...
	var PageController = Controller.extend("sap.ui.demo.toolpageapp.controller.HR.OrganizationalChart.Page", {
		onInit : function (evt) {
			// set explored app's demo model on this sample
			var oModel = new JSONModel(jQuery.sap.getModulePath("sap.ui.demo.toolpageapp.model.HR.OrganizationalChart", "/Tree.json"));
