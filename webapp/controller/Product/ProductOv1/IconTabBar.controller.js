sap.ui.define([
	...
	var IconTabBarController = Controller.extend("sap.ui.demo.toolpageapp.controller.Product.ProductOv1.IconTabBar", {

		onInit: function () {

			// set explored app's demo model on this sample
			var oModel = new JSONModel(jQuery.sap.getModulePath("sap.ui.demo.toolpageapp.model.Product", "/products.json"));
